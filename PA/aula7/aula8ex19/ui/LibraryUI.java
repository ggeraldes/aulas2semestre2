package pt.isec.henrique.aula8ex19.ui;

import pt.isec.henrique.aula5ex11.utils.PAInput;
import pt.isec.henrique.aula8ex19.model.Book;
import pt.isec.henrique.aula8ex19.model.ILibrary;
import pt.isec.henrique.aula8ex19.model.OldBook;
import pt.isec.henrique.aula8ex19.model.RecentBook;
    ...
    public void start() {
        while (true) {
            switch (PAInput.chooseOption("Library Manager - " + lib.getName(),
                    "Add new book", "Search book", "Remove book", "Show books", "Show sorted books",
                    "Quit")) {
                case 1:
                    addBook();
                    break;
